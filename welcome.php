...
<body>
  <?php
     ...
     if (!empty($username) || !empty($email) || !empty($password)) {
      ...
      <div class="container">
      <h5>Thanks for registering at Lorem ipsum</h5>
      <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Distinctio ab excepturi exercitationem est ipsam nam, culpa consequatur porro suscipit eos modi odit in reprehenderit blanditiis maiores nulla dicta sunt voluptas!</p>
      <h5>What can you do now?</h5>
        ...
        <p>When, while the lovely valley teems with vapour around me, and the meridian sun strikes the upper surface of the impenetrable foliage of my trees, and but a few stray gleams steal into the inner sanctuary, I throw myself down among the tall grass
          ...
          then I feel the presence of the Almighty, who formed us in his own image, and the breath of that universal love which bears <img src="lorem_3.png" /> <br> and sustains us.  As it floats around us in an eternity of bliss; and then, my friend,
